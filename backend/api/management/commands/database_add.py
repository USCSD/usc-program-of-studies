...
class Command(BaseCommand):
    ...
    def handle(self, **options):
        ...
        for line in master:
            ...
            a_class.save()
            if line[15] == "X":
                business = Career.objects.get(
                    career_name="Business Management and Administration"
                )
            ...
            if line[24] == "X":
                temp = Career.objects.get(
                    career_name="Government and Public Administration"
                )
                temp.suggested_classes.add(a_class)
                a_class.careers.add(temp)
            if line[25] == "X":
            ...
            if line[27] == "X":
                temp = Career.objects.get(
                    career_name="Law, Public Safety, Corrections and Security"
                )
                temp.suggested_classes.add(a_class)
                a_class.careers.add(temp)
            if line[29] == "X":
                temp = Career.objects.get(
                    career_name="Agriculture, Food and Natural Services"
                )
                temp.suggested_classes.add(a_class)
                a_class.careers.add(temp)
            if line[14] == "X":
            ...
            if line[21] == "X":
                temp = Career.objects.get(
                    career_name="Transportation, Distribution and Logistics"
                )
                temp.suggested_classes.add(a_class)
                a_class.careers.add(temp)
            if line[22] == "X":
                temp = Career.objects.get(
                    career_name="Science, Technology, and Mathematics"
                )
                temp.suggested_classes.add(a_class)
                a_class.careers.add(temp)
            a_class.save()
