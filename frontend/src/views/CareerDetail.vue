          ...
          <div class="card">
            <div class="card-content">
              <div class="box has-text-centered ">
                <h1 class="title is-3">Career: {{career_detail.career_name}}</h1>
                <p
                  class="is-1"
                ...
                <table class="table is-bordered is-fullwidth">
                  ...
                  <tbody>
                    ...
                    >
                      ...
                      <td>
                        <router-link :to="{name:'detail', params: {id: classdata.id}}">{{classdata.class_name}}</router-link>
                      </td>
